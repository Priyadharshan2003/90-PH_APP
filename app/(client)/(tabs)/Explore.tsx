      ...
      <TouchableOpacity
        ...
        <View style={styles.cardContainer}>
          ...
          <View style={styles.cardImageContainer}>
            <Image
              ...
              onError={(e) => {
                if (e.nativeEvent.error) {
                  console.warn(
                    `Failed to load image for plot ${item.title}: ${e.nativeEvent.error}`
                  );
                }
              }}
            />
            ...
            <View
              style={[
                ...
                {
                  backgroundColor:
                    item.status.toLowerCase() === 'available' ? colors.success : colors.error,
                },
              ]}>
            ...
            <View style={styles.priceTag}>
              <Text style={[styles.priceTagMainText, { fontFamily: 'manrope' }]}>
                {formatPrice(item.price)}
              </Text>
              <Text style={[styles.priceTagSubText, { fontFamily: 'manrope' }]}>Onwards</Text>
            </View>
          </View>
          ...
          <View style={styles.cardContent}>
            {/* Title and Location */}
            <Text style={[styles.cardTitle, { fontFamily: 'manrope' }]}>{item.title}</Text>
            <View style={styles.cardLocation}>
              <Ionicons name="location-outline" size={scale(16)} color={colors.accent} />
              <Text style={[styles.cardLocationText, { fontFamily: 'manrope' }]}>
                {item.location}
              </Text>
            </View>
            ...
            <View style={styles.cardDetailsGrid}>
              <View style={styles.cardDetailItem}>
                ...
                <Text style={[styles.cardDetailText, { fontFamily: 'manrope' }]}>
                  {item.dimension}
                </Text>
              </View>
              ...
              <View style={styles.cardAmenitiesContainer}>
                {item.amenities.slice(0, 3).map((amenity: string, index: number) => (
                  <View key={index} style={styles.amenityTag}>
                    <Text style={[styles.amenityText, { fontFamily: 'manrope' }]}>{amenity}</Text>
                  </View>
                ))}
                {item.amenities.length > 3 && (
                  <View style={styles.amenityTag}>
                    <Text style={[styles.amenityText, { fontFamily: 'manrope' }]}>
            ...
            <TouchableOpacity
              ...
              <Text style={[styles.viewDetailsButtonText, { fontFamily: 'manrope' }]}>
                View Details
              </Text>
            </TouchableOpacity>
          </View>
      ...
      <SafeAreaView style={styles.flexCenter} edges={['top', 'bottom']}>
        ...
        <Animated.View
          ...
          <TouchableOpacity
            ...
            accessibilityRole="button"
            accessibilityLabel="Retry loading plots">
            <Text style={[styles.retryButtonText, { fontFamily: 'manrope' }]}>Try Again</Text>
          </TouchableOpacity>
        </Animated.View>
      </SafeAreaView>
    );
      ...
      <Animated.View
        ...
        <View style={styles.searchBar}>
          ...
          <TextInput
            ...
            style={[styles.searchInput, { fontFamily: 'manrope' }]}
            value={searchQuery}
      ...
      <FlatList
        ...
        ListEmptyComponent={
          <Animated.View
            ...
            <Text style={[styles.emptyStateTitle, { fontFamily: 'manrope' }]}>No plots found</Text>
